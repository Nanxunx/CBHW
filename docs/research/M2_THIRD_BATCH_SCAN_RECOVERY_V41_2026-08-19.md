...
8. Golden Source 继续只读：`E:\335_FinalExtract_V5`、`E:\335to112_Converted_FinalExtract_V1`。
...
```powershell
& "D:\MPQ\Run_ModelPort_FullScan_V41.ps1"
```

输出：

```text
E:\ModelPort_GoldenUpload_ThirdBatch_V41\
  STAGING\00_Metadata\
